...
import com.opticsolutions.jcf.lists.ListIterable;
import com.opticsolutions.jcf.lists.ListIterator;
...
public class DefaultMyList implements MyList, ListIterable {
	 ...
	 * current position in the list. A ListIteratorImpl has no current element; its
	 * cursor position always lies between the element that would be returned by a
	 * call to {@code previous()} and the element that would be returned by a call
	 * to {@code next()}.
	 * 
	 */
